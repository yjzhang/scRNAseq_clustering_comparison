---
title: "Import and QC of Trapnell TCC data set (GSE52529-GPL16791)"
...
```{r load-dataset}
(se <- readRDS("../../data/data_raw/GSE52529-GPL16791TCC.rds"))
...
dim(sce)
table(sce$phenoid)
saveRDS(sce, file = "../../data/sce_full/sce_full_TrapnellTCC.rds")
```
