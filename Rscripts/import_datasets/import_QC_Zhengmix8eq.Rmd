...
```{r load-dataset}
b.cells <- read10xCounts("../../data/data_raw/zheng/b_cells/filtered_matrices_mex/hg19") 
naive.cytotoxic <- read10xCounts("../../data/data_raw/zheng/naive_cytotoxic/filtered_matrices_mex/hg19")
cd14.monocytes <- read10xCounts("../../data/data_raw/zheng/cd14_monocytes/filtered_matrices_mex/hg19")
regulatory.t <- read10xCounts("../../data/data_raw/zheng/regulatory_t/filtered_matrices_mex/hg19")
cd4.t.helper <- read10xCounts("../../data/data_raw/zheng/cd4_t_helper/filtered_matrices_mex/hg19")
cd56.nk <- read10xCounts("../../data/data_raw/zheng/cd56_nk/filtered_matrices_mex/hg19")
memory.t <- read10xCounts("../../data/data_raw/zheng/memory_t/filtered_matrices_mex/hg19")
naive.t <- read10xCounts("../../data/data_raw/zheng/naive_t/filtered_matrices_mex/hg19")
...
expl_vars <- c("phenoid", "log10_total_counts", "log10_total_features_by_counts", "pct_dropout",
